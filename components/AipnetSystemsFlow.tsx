...
const valueChains: ValueChain[] = [
  ...
  },
  {
    ...
    nodes: [
      { id: "fuel_feedstocks_br", name: "Biomassa e Insumos", country: "Brasil", flag: "🇧🇷", stage: "Insumo", description: "Base agroindustrial, resíduos e insumos necessários às rotas de baixo carbono.", relatedInputs: ["Biomassa", "Etanol", "Biogás e biometano"], isCritical: false, isVulnerable: false, icon: Factory },
      { id: "fuel_conversion_br", name: "Conversão e Bioprocessos", country: "Brasil", flag: "🇧🇷", stage: "Insumo", description: "Fermentação, digestão, síntese e conversão de matérias-primas em moléculas intermediárias.", relatedInputs: ["Enzimas", "Catalisadores", "Metanol"], isCritical: false, isVulnerable: false, icon: Layers },
      ...
      { id: "fuel_final_br", name: "Combustíveis e Usos Finais", country: "Brasil", flag: "🇧🇷", stage: "Aplicação final", description: "Hidrogênio renovável, SAF, biometano e e-combustíveis abastecem aviação, indústria e transporte pesado.", relatedInputs: ["Hidrogênio", "Combustíveis de aviação / proxy SAF", "Gás natural / proxy biometano", "Metanol", "Amônia"], relatedDestinations: transitionFuelDestinations, isCritical: false, isVulnerable: false, icon: Zap },
    ],
  },
  {
    ...
    nodes: [
      { id: "fertilizer_resources", name: "Recursos Minerais e Gás", country: "Brasil", flag: "🇧🇷", stage: "Matéria-prima", description: "Gás natural, rocha fosfática e recursos potássicos formam a base da cadeia.", relatedInputs: ["Rocha fosfática", "Potássio", "Gás natural"], isCritical: false, isVulnerable: false, icon: Factory },
      { id: "fertilizer_intermediates", name: "Intermediários Químicos", country: "Múltiplas origens", flag: "🌐", stage: "Insumo", description: "Amônia, ureia, ácido fosfórico e sais potássicos concentram a exposição comercial.", relatedInputs: ["Amônia", "Ureia", "Ácido fosfórico", "Cloreto de potássio"], isCritical: true, isVulnerable: true, alertMessage: "O grau de dependência e concentração varia por nutriente e deve ser consultado no diagnóstico abaixo.", icon: ShieldAlert },
      { id: "fertilizer_blending_br", name: "Formulação e Mistura", country: "Brasil", flag: "🇧🇷", stage: "Transformação", description: "Mistura, granulação e formulação adaptam nutrientes às necessidades agronômicas.", relatedInputs: ["Fertilizantes NPK", "Micronutrientes", "Bioinsumos"], isCritical: false, isVulnerable: false, icon: Layers },
  ...
  },
  {
    ...
    nodes: [
      { id: "steel_inputs_br", name: "Minério, Sucata e Redutores", country: "Brasil", flag: "🇧🇷", stage: "Insumo", description: "Minério de ferro, sucata, carvão vegetal e energia compõem a base material da siderurgia.", relatedInputs: ["Minério de ferro", "Sucata ferrosa", "Carvão vegetal"], isCritical: false, isVulnerable: false, icon: Factory },
      { id: "steel_reduction_br", name: "Redução e Aciaria", country: "Brasil", flag: "🇧🇷", stage: "Transformação", description: "Altos-fornos, redução direta e fornos elétricos convertem a carga em aço bruto.", relatedInputs: ["Ferro-gusa", "Aço bruto", "Eletrodos"], isCritical: false, isVulnerable: false, icon: Layers },
      { id: "steel_alloys_global", name: "Ligas e Tecnologia de Processo", country: "Múltiplas origens", flag: "🌐", stage: "Transformação", description: "Ferroligas, refratários e equipamentos condicionam qualidade e descarbonização.", relatedInputs: ["Ferroligas", "Refratários", "Equipamentos siderúrgicos"], isCritical: true, isVulnerable: true, alertMessage: "Itens críticos são identificados pelo risco comercial observado; a topologia não atribui concentração sem homologação.", icon: ShieldAlert },
      { id: "steel_products_br", name: "Aços e Bens da Transição", country: "Brasil", flag: "🇧🇷", stage: "Equipamento e uso final", description: "Chapas, tubos, cabos e estruturas abastecem energia, mobilidade e infraestrutura verde.", relatedInputs: ["Chapas e bobinas", "Tubos", "Estruturas metálicas"], isCritical: false, isVulnerable: false, icon: Zap },
    ],
  },
];
