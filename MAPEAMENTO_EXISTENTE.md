...
- Fix decoupled ainda recomendado, independente desta decisao: `database/data_access.py:455` retorna `"Matriz Insumo-Produto IBGE"` como rotulo default de `fonte_proxy`, mas nenhum arquivo do IBGE (ou do NEREUS) e lido em lugar nenhum do pipeline -- o rotulo e enganoso e deveria virar algo como "aproximacao equal-weight (sem MIP)".
